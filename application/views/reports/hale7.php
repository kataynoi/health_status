        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th colspan="9" class="text-center">HALE(Health adjusted life expectancy)</th>
                </tr>
                <tr>
                    <th>2559</th>
                    <th>2560</th>
            ...
            <tbody>
                ...
                foreach ($hale7 as $r) {
                    ...
                    <td>" . number_format($r->y2022, 4) . " </td>
                    <td>" . number_format($r->y2023, 4) . " </td>
                    <td>" . number_format($r->y2024, 4) . " </td></tr>";
                    $n++;
                }
