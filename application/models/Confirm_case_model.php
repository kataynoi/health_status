 ...
 */
class Confirm_case_model extends CI_Model
{
    var $table = "confirm_case";
    ...
    /* End Datatable*/
    public function del_confirm_case($id)
    {
        $rs = $this->db
            ->where('id', $id)
            ->delete('confirm_case');
    ...
    public function save_confirm_case($data)
    {
    ...
    public function update_confirm_case($data)
    {
        $birth= to_mysql_date($data["birth"]);
        $lab_date= to_mysql_date($data["lab_date"]);
        $travel_date= to_mysql_date($data["travel_date"]);
